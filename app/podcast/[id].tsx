...
export default function PodcastDetailsScreen() {
  ...
  const item = useSelector((state: RootState) => {
    const { podcasts } = state.data;
    return podcasts.find((i) => i.id === id);
  });
  ...
  const displayItem: Item = item || {
    ...
    description: 'This podcast could not be found.',
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.content}>
          ...
          <GlassView style={styles.descriptionCard}>
            <Text style={[styles.sectionTitle, { color: colors.text.accent }]}>About</Text>
